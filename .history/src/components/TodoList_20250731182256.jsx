...
function TodoList({ category }) {
  ...
  return (
    <div className=' space-y-8'>
      <form onSubmit={handleSubmit} className=" flex flex-col justify-center gap-2 mb-4">
        <input
          value={input}
        ...
        />
        <button type="submit" className="bg-buttonDark space-y-8  px-4 rounded">أضف</button>
      </form>
      <div className=" m-auto max-w-80 mb-20 space-y-8 ">
        <table className='table-auto space-y-8 w-full'>
          <thead>
            <tr>
