...
function TodoItem({ todo }) {
  ...
  return (
    <div className="relative">
      ...
      {/* Slider تعديل */}
      {showEdit && (
        <div className="fixed top-0 right-0 h-full w-80 bg-white dark:bg-deepMint_800 shadow-lg p-6 z-50">
      ...
      {/* Slider تأكيد الحذف */}
      {showConfirmDelete && (
        <div className="fixed top-0  h-full w-80 bg-white dark:bg-deepMint_800 shadow-lg p-6 z-50">
