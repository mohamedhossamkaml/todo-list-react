          ...
          <AnimatePresence>
            {showCategoriesList && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.3 }}
                className="absolute top-full right-6 mt-2 w-[300px] max-h-[400px] overflow-y-auto bg-white dark:bg-deepMint_800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-600 z-40"
              >
