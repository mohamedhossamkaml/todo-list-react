...
function TodoItem({ todo }) {
  ...
  return (
    <table className={` border-separate border-spacing-2 border border-gray-400 dark:border-gray-500  p-3  rounded shadow-md ${todo.completed ? 'bg-green-200' : 'bg-white'}`}>
      <thead>
        <tr>
          <th>Todos</th>
          <th>buttons</th>
