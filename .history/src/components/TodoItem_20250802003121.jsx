...
function TodoItem({ todo }) {
  ...
  return (
    <>
      ...
      {/* تعديل المهمة */}
      {isEditing && (
        <div className="fixed top-0 w-80  bg-white dark:bg-deepMint_900 shadow-lg p-6 z-50 overflow-y-auto">
      ...
      {/* تأكيد الحذف */}
      {isConfirmingDelete && (
        <div className="fixed top-0  w-80  bg-white dark:bg-deepMint_900 shadow-lg p-6 z-60 overflow-y-auto">
