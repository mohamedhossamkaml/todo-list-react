...
function TodoList({ category }) {
  ...
  return (
    <div className=' space-y-8'>
      <form onSubmit={handleSubmit} className=" flex flex-col space-y-2  justify-center mb-4">
        <input
          value={input}
        ...
        />
        <button type="submit" className="bg-cyan-500 space-y-4 rounded-full  ">أضف</button>
      </form>
      <div className=" m-auto max-w-80 mb-20 space-y-8 ">
        <table className='table-auto py-3 rounded shadow-md w-full'>
          <thead>
            <tr>
              <th>Todos</th>
              <th >Actions</th>
